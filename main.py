...
<body>
    ...
    <span class="neon-pink">𝐍𝐀𝐒𝐈𝐈𝐑</span>
    <span class="neon-purple">𝐀𝐋𝐈𝐈</span>
</h2>
...
@keyframes linePulse {
    ...
    50% {
        transform: scaleX(1);
                ...
                <div class="mt-3">
<p class="mb-0 copyright-text">©𝟐𝟎𝟐𝟓 𝐀𝐥𝐥 𝐫𝐢𝐠𝐡𝐭𝐬 𝐫𝐞𝐬𝐞𝐫𝐯𝐞𝐝 𝐁𝐲 𝐍𝐚𝐒𝐢𝐢𝐫 𝐀𝐥𝐢𝐢 𝐊𝐢𝐢𝐧𝐠</p>
